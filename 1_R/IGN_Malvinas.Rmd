...
```{r leaflet0, echo=FALSE}
#para guardar el html y luego poder incluirlo en la web
tmap_save(mapa, "mapa_tmap.html") 
```
...
saveWidget(mapa_base1, "mapa_base1.html")
```
...
saveWidget(mapa_base2, "mapa_base2.html")
```
...
saveWidget(mapa_base_IGN, "mapa_base_IGN.html")
```
...
saveWidget(mapa_final, "mapa_final.html")
```
